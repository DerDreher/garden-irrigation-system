...
void handleNewMessages(int numNewMessages) {
  ...
  for (int i = 0; i < numNewMessages; i++) {
    ...
    if (chat_id == String(SchrappeChat) || chat_id == String(AdminID) || chat_id == String(AdminID2)) {
      ...
      if (bot.messages[i].type == F("callback_query")) {
        ...
        if (text == F("/status")) {
          ...
          statusstring += "\n";
          /*
                  statusstring += "\xF0\x9F\x94\xB4 Kreis 1\n";
                  statusstring += "\xF0\x9F\x94\xB4 Kreis 2\n";
                  statusstring += "\xf0\x9f\x9f\xa2 Kreis 3 läuft noch 2min \n";
                  statusstring += "\xf0\x9f\x9f\xa1 Kreis 4 in Warteschlange\n\n";
          */
        ...
        if (text == F("/otaupdate")) {
          ...
          //handsteuerungJson += F("{ \"text\" : \"Stop\", \"callback_data\" : \"OTASTOP\" }]]");
        ...
        if (text == F("/bewaesserungsdauer")) {
          ...
          // bot.sendMessageWithInlineKeyboard(chat_id, "Aktuelle Einstellungen sind:\n\n  -Kreis 2 + 08min\n -Kreis 3 + 10min\n -Kreis 4 + 04min\nWelchen Kreis möchtest du ändern?\n\n oder zurück zu den /einstellungen", "", bewaesserungsdauerJson);
        }
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        if (text == F("/bewaesserungsplan")) {
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        if (text.startsWith("/plan")) { // inputstring  "/plan14kreis1start5:00jeden2tag" oder kurz "/plan14-1-5-0-2"
    ...
    else { bot.sendMessage(chat_id, "Du verfügst nicht über die nötigen Rechte den Bot zu steuern.", "Markdown"); }
  }
}
